...
+ (void)setupConfigurationTemplate {
    ...
    QMUICMI.navBarBackgroundImage = [UIImage imageWithColor:UIColorMakeWithHex(CAT_THEME_COLOR)];                                        // NavBarBackgroundImage : UINavigationBar 的背景图
    QMUICMI.navBarShadowImage = [UIImage imageWithColor:UIColorMakeWithHex(CAT_THEME_COLOR)];                                            // NavBarShadowImage : UINavigationBar.shadowImage，也即导航栏底部那条分隔线
    ...
    QMUICMI.navBarTitleFont = [UIFont boldSystemFontOfSize:18];                                              // NavBarTitleFont : UINavigationBar 的标题字体，以及 QMUINavigationTitleView 的默认字体
    QMUICMI.navBarBackButtonTitlePositionAdjustment = UIOffsetZero;             // NavBarBarBackButtonTitlePositionAdjustment : 导航栏返回按钮的文字偏移
    QMUICMI.navBarBackIndicatorImage = UIImageMake(@"navi_back");                                     // NavBarBackIndicatorImage : 导航栏的返回按钮的图片
    ...
    QMUICMI.tabBarTintColor = UIColorMakeWithHex(CAT_THEME_COLOR);                                              // TabBarTintColor : UITabBar 的 tintColor
    ...
    QMUICMI.tableViewGroupedSectionHeaderDefaultHeight = 15;                                            // TableViewGroupedSectionHeaderDefaultHeight : Grouped 类型的 QMUITableView sectionHeader 的默认高度
    QMUICMI.tableViewGroupedSectionFooterDefaultHeight = 1;                                             // TableViewGroupedSectionFooterDefaultHeight : Grouped 类型的 QMUITableView sectionFooter 的默认高度
